...
unsafe def main : IO Unit := do
  ...
  withImportModules #[{module := `Std.Internal.Parsec.Basic}] {} fun env => do
    IO.println <| (Json.mkObj [("meta", Json.mkObj [
      ("exporter", Json.mkObj [("name", "std-internal-parsec-core-roots"), ("version", "0")]),
      ("lean", Json.mkObj [("githash", githash), ("version", versionString)]),
      ("format", Json.mkObj [("version", "3.1.0")])
    ])]).compress
    let roots := [`Std.Internal.Parsec.Error, `Std.Internal.Parsec.ParseResult, `Std.Internal.Parsec, `Std.Internal.Parsec.Input, `Std.Internal.Parsec.pure, `Std.Internal.Parsec.bind, `Std.Internal.Parsec.fail, `Std.Internal.Parsec.tryCatch, `Std.Internal.Parsec.orElse, `Std.Internal.Parsec.attempt, `Std.Internal.Parsec.eof, `Std.Internal.Parsec.isEof, `Std.Internal.Parsec.manyCore, `Std.Internal.Parsec.many, `Std.Internal.Parsec.many1, `Std.Internal.Parsec.any, `Std.Internal.Parsec.satisfy, `Std.Internal.Parsec.notFollowedBy, `Std.Internal.Parsec.peek?, `Std.Internal.Parsec.peekWhen?, `Std.Internal.Parsec.peek!, `Std.Internal.Parsec.peekD, `Std.Internal.Parsec.skip, `Std.Internal.Parsec.manyCharsCore, `Std.Internal.Parsec.manyChars, `Std.Internal.Parsec.many1Chars]
    let _ ← (do
