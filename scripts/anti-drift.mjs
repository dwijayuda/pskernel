...
if (existsSync(join(root,'packages','native-ir'))) throw new Error('Anti-drift violation: no workspace native-ir provider is approved by the current self-hosting plan');
