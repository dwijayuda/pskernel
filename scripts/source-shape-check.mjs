...
const scopes=['syntax','meta','environment','checked-core','elab','language','language-service','erasure','compiler-ir','backend-ts','wasm-ir','wasm-lowering','backend-wasm','compiler','lsp','cli'];
const maxLines=300;
