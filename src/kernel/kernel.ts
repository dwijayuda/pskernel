...
function tcFor(env:Environment,lparams:readonly Name[],safety:DefinitionSafety='safe'):TypeChecker{return new TypeChecker(env,new LocalContext(),undefined,undefined,safety,lparams);}
