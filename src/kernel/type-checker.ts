...
export class TypeChecker {
  ...
  private isDefEqCore(a:Expr,b:Expr):boolean{return this.rec(()=>{
    ...
    if(!exprLeanEq(x,a)||!exprLeanEq(y,b)){const q2=this.quick(x,y);if(q2!==null)return q2;}
    ...
    const xx=this.whnfCore(x,false,false),yy=this.whnfCore(y,false,false);if(!exprLeanEq(xx,x)||!exprLeanEq(yy,y))return this.isDefEqCore(xx,yy);
