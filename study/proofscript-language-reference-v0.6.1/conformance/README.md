# ProofScript v0.6.1 Conformance Suite
...
Passing this corpus is not S2 by itself. S2 requires a pinned Lean 4.33.1 reference parser/lowering proof. Passing this corpus is a prerequisite for production-refinement work.
